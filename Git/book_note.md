...
`git rebase` 的 `-i`/`-interactive` 选项可以对提交进行**重新排序**、**编辑**、**删除**，把多个提交**合并成一个**，把一个提交**分离成多个**。<!-- TODO: 未验证 -->
...
- 但发送之前，需要配置 `sendemail.`，更多选项请查阅资料。（我也没发送成功）<!-- TODO: -->
